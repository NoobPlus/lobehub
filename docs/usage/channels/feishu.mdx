...
<Steps>
  ...
  > You can find the Verification Token and Encrypt Key in the Feishu/Lark Developer Portal under **Event Subscription** → **Encryption Strategy** at the top of the page. If you haven't opened the Event Subscription page yet, you can fill in the Verification Token after Step 4.
...
| **Verification Token**     | Yes      | Verifies webhook event source                                        |
