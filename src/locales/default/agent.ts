export default {
  ...
  'integration.appSecret': 'App Secret',
  'integration.appSecretPlaceholder': 'Paste your app secret here',
  ...
  'integration.encryptKey': 'Encrypt Key',
  'integration.encryptKeyHint': 'Optional. Used to decrypt encrypted event payloads.',
  'integration.encryptKeyPlaceholder': 'Optional encryption key',
  'integration.endpointUrl': 'Webhook URL',
  ...
  'integration.feishu.description': 'Connect this assistant to Feishu for private and group chats.',
  'integration.lark.description': 'Connect this assistant to Lark for private and group chats.',
  ...
  'integration.telegram.description':
    'Connect this assistant to Telegram for private and group chats.',
  ...
  'integration.verificationToken': 'Verification Token',
  'integration.verificationTokenHint': 'Optional. Used to verify webhook event source.',
  'integration.verificationTokenPlaceholder': 'Optional verification token',
} as const;
